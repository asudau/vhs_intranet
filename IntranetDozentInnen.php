...
class IntranetDozentInnen extends StudIPPlugin implements PortalPlugin
{
    ...
    function __construct()
    {
        ...
        $this->seminars = array('2dac34217342bd706ac114d57dd0b3ec');
    ...
    {
        return _('Intranet für DozentInnen');
    }

    public function getPortalTemplate()
    {
        $template = $this->template_factory->open('infos');
		$template->set_attribute('title', 'Intranet für DozentInnen');
        ...
        if (get_config('NEWS_RSS_EXPORT_ENABLE')) {
            if ($rss_id = StudipNews::GetRssIdFromRangeId('2dac34217342bd706ac114d57dd0b3ec')) {
